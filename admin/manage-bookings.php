							...
							<div class="panel-body">
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover"
									...
									<tbody>
										...
										<?php $sql = "SELECT tblusers.FullName,tblbrands.BrandName,tblvehicles.VehiclesTitle,tblvehicles.VehicleProviderid,tblbooking.FromDate,tblbooking.ToDate,tblbooking.message,tblbooking.VehicleId as vid,tblbooking.Status,tblbooking.PostingDate,tblbooking.id  from tblbooking join tblvehicles on tblvehicles.id=tblbooking.VehicleId join tblusers on tblusers.EmailId=tblbooking.userEmail join tblbrands on tblvehicles.VehiclesBrand=tblbrands.id  ORDER BY tblbooking.PostingDate desc ";
	$query = $dbh->prepare($sql);
	$query->execute();
