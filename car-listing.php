...
{  ?>
        <div class="product-listing-m gray-bg">
          <div class="product-listing-img"><a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="Image" /> </a> 
          </div>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          ...
          <div class="sidebar_filter">
            <form action="filter-carresult.php" method="post" >
...
{  ?>
              ...
              <li class="gray-bg">
                <div class="recent_post_img"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
