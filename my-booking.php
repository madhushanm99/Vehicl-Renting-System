...
<head>
  ...
  <title>Car Rental Portal | Booking</title>
    ...
    foreach ($results as $result) { ?>
                  ...
                  <li>
                    <div class="vehicle_img"> <a
                        href="vehical-details.php?vhid=<?php echo htmlentities($result->vid); ?>"><img src="<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
                ...
                <div class=" vehicle_status"> <a href="#" class="btn outline btn-xs active-btn" style="pointer-events: none">Confirmed</a>
                          <div class="clearfix"></div>
                    </div>

                    <?php } else if ($result->Status == 2) { ?>
                    <div class="vehicle_status"> <a href="#" class="btn outline btn-xs" style="pointer-events: none">Cancelled</a>
                      <div class="clearfix"></div>
                    </div>
