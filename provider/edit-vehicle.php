...
<body>
	...
	if ($query->rowCount() > 0) {
		foreach ($results as $result) { ?>
										<a href="manage-vehicles.php"><button class="btn btn-primary " name="back">
												Back</button></a>
...
?>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<select class="selectpicker" name="fueltype" required>
														...
														<option value="Petrol" <?php echo
															($result->FuelType=="Petrol") ? "selected='selected'" : ""; ?>
															>Petrol</option>
														<option value="Diesel" <?php echo
															($result->FuelType=="Diesel") ? "selected='selected'" : ""; ?>
															>Diesel</option>
														<option value="CNG" <?php echo
															($result->FuelType=="CNG") ? "selected='selected'" : ""; ?>>CNG
														</option>
													</select>
												</div>
											</div>
											...
											<div class="form-group">
												<div class="col-sm-4">
													Image 1 <img src="../<?php echo htmlentities($result->Vimage1); ?>"
												...
												<div class="col-sm-4">
													Image 2<img src="../<?php echo htmlentities($result->Vimage2); ?>"
														width="300" height="200" style="border:solid 1px #000">
													<a
												...
												<div class="col-sm-4">
													Image 3<img src="../<?php echo htmlentities($result->Vimage3); ?>"
														width="300" height="200" style="border:solid 1px #000">
													<a
											...
											<div class="form-group">
												<div class="col-sm-4">
													Image 4<img src="../<?php echo htmlentities($result->Vimage4); ?>"
														width="300" height="200" style="border:solid 1px #000">
													<a
				...
				echo htmlentities("File not available");
													...
													<img src="../<?php echo htmlentities($result->Vimage5); ?>"
														width="300" height="200" style="border:solid 1px #000">
													<a
