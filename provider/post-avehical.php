...
if (strlen($_SESSION['plogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		// move_uploaded_file($_FILES["img1"]["tmp_name"],"../assets/vimg/".$_FILES["img1"]["name"]);
// move_uploaded_file($_FILES["img2"]["tmp_name"],"../assets/vimg/".$_FILES["img2"]["name"]);
// move_uploaded_file($_FILES["img3"]["tmp_name"],"../assets/vimg/".$_FILES["img3"]["name"]);
...
<body>
	...
	if ($query->rowCount() > 0) {
		foreach ($results as $result) {
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Price Per Day(Rs)<span
														style="color:red">*</span></label>
												<div class="col-sm-4">
